...
function getCovidStats() {
  ...
  _axios.default.get(usaUrl).then(resp => {
    //call that data resp and do stuff with it inside curly brace
    return resp.data;
  }).then(function (data) {
...
function getCovidStats2() {
  _axios.default.get('https://coronavirus-tracker-api.herokuapp.com/v2/locations/180').then(resp => {
    //call that data resp and do stuff with it inside curly brace
    return resp.data;
  }).then(function (data) {
    ...
    document.getElementById('percent2').innerHTML = (Number(deaths2) / Number(confirmedCases2) * 100).toLocaleString("en", {
      minimumFractionDigits: 2,
      maximumFractionDigits: 2
    }) + "%";
  }).catch(function () {
...
function getCovidStats3() {
  _axios.default.get('https://coronavirus-tracker-api.herokuapp.com/v2/locations/205').then(resp => {
    //call that data resp and do stuff with it inside curly brace
    return resp.data;
  }).then(function (data) {
    ...
    document.getElementById('percent3').innerHTML = (Number(deaths3) / Number(confirmedCases3) * 100).toLocaleString("en", {
      minimumFractionDigits: 2,
      maximumFractionDigits: 2
    }) + "%";
  }).catch(function () {
...
function getCovidStats4() {
  _axios.default.get('https://coronavirus-tracker-api.herokuapp.com/v2/locations/8').then(resp => {
    //call that data resp and do stuff with it inside curly brace
    return resp.data;
  }).then(function (data) {
    ...
    document.getElementById('percent4').innerHTML = (Number(deaths4) / Number(confirmedCases4) * 100).toLocaleString("en", {
      minimumFractionDigits: 2,
      maximumFractionDigits: 2
    }) + "%";
  }).catch(function () {
